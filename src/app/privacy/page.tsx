...
export default function Privacy() {
  ...
  return (
    <div className='p-10 w-full  bg-[#111] rounded-lg h-full  z-10 box-border '>
      <h1 className='text-[24px]'>Zellet Privacy Policy</h1>
      <div className=' mb-10 overflow-y-scroll text-justify pr-4 leading-8 font-light text-[14px]'>
